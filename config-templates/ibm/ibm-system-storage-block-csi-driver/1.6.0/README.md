...
For full release notes, compatiblity, installation, and user information, see the [IBM block storage CSI driver documentation](https://www.ibm.com/docs/en/stg-block-csi-driver/1.6.0).
...
Review the [compatibility and requirements documentation](https://www.ibm.com/docs/en/stg-block-csi-driver/1.6.0?topic=installation-compatibility-requirements). 
...
```sh
ibmcloud sat storage template get --name ibm-system-storage-block-csi-driver --version 1.6.0
```

 **IBM block storage CSI driver parameters**
 
 For more information about the fields and examples, review the [Creating a StorageClass documentation](https://www.ibm.com/docs/en/stg-block-csi-driver/1.6.0?topic=configuration-creating-storageclass)
...
[Troubleshooting documentation](https://www.ibm.com/docs/en/stg-block-csi-driver/1.6.0?topic=troubleshooting)
